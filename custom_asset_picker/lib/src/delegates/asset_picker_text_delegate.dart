...
class VietnameseAssetPickerTextDelegate extends AssetPickerTextDelegate {
  ...
  @override
  String get emptyList => 'Không có hình ảnh/video';

  @override
  String get unSupportedAssetType => 'Không hỗ trợ định dạng này';

  @override
  String get unableToAccessAll =>
      'Không thể truy cập tất cả các tệp trong thiết bị';

  @override
  String get viewingLimitedAssetsTip => 'Chỉ xem được các tệp có thể truy cập';

  @override
  String get changeAccessibleLimitedAssets => 'Nhấn để cập nhật quyền truy cập';

  @override
  String get accessAllTip => 'Ứng dụng chỉ có thể truy cập vào một số tệp. '
      'Vào thiết lập hệ thống để cấp quyền truy cập vào tất cả các tệp cho ứng dụng.';

  @override
  String get goToSystemSettings => 'Vào thiết lập hệ thống';

  @override
  String get accessLimitedAssets => 'Tiếp tục với quyền truy cập bị giới hạn';

  @override
  String get accessiblePathName => 'Các tệp được phép truy cập';
  ...
  @override
  String get sActionPlayHint => 'chạy';
  ...
  @override
  String get sActionSwitchPathLabel => 'đổi thư mục';

  @override
  String get sActionUseCameraHint => 'sử dụng camera';

  @override
  String get sNameDurationLabel => 'thời gian';
