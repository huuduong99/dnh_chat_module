...
class _AttachmentApi implements AttachmentApi {
  _AttachmentApi(
    this._dio, {
    this.baseUrl,
  });
  ...
  Future<ObjectListResult<Attachment>> getAttachments({
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ObjectListResult<Attachment>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/api/v1/attachment/conversation-paging',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ObjectListResult<Attachment>.fromJson(_result.data!);
    return value;
  }
